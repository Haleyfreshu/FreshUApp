    ...
    <Shell>
      <div style={{ flex: 1, display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", padding: "0 26px" }}>
        <div style={{ background: "#fff", borderRadius: 24, padding: "34px 26px", textAlign: "center", width: "100%" }}>
          ...
          <div style={{ fontFamily: "'Space Grotesk',sans-serif", fontWeight: 800, fontSize: 18, color: "#0B0E1A" }}>
            {stillProcessing ? "Payment received!" : "Order confirmed!"}
          </div>
          <div style={{ fontSize: 13, color: "#6B7290", marginTop: 6 }}>
            {stillProcessing
          ...
          <a href="/orders" style={{ display: "block", textDecoration: "none", width: "100%", marginTop: 18, padding: 14, borderRadius: 14, border: "none", background: "#0B0E1A", color: "#fff", fontWeight: 800, cursor: "pointer" }}>
            View Orders
          </a>
        </div>
      </div>
