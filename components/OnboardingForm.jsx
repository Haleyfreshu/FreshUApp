  ...
  return (
    <div style={{ flex: 1, display: "flex", flexDirection: "column", padding: "50px 24px 24px" }}>
      ...
      <div style={{ display: "flex", gap: 10, marginTop: 16 }}>
        {step > 0 && (
          <button onClick={() => setStep(s => s - 1)} style={{ flex: 1, padding: "15px", borderRadius: 14, border: "1.5px solid var(--fu-border)", background: "var(--fu-card)", fontWeight: 700, color: "var(--fu-text)", cursor: "pointer" }}>Back</button>
        )}
        <button
