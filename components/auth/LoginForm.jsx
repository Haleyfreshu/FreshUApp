    ...
    <div style={{ flex: 1, display: "flex", flexDirection: "column", padding: "60px 26px 30px", justifyContent: "space-between" }}>
      <div>
        ...
        <button
          ...
          style={{ width: "100%", marginTop: 8, padding: "16px", borderRadius: 16, border: "none", background: "var(--fu-cta-bg)", color: "var(--fu-cta-text)", fontWeight: 800, fontSize: 15.5, cursor: loading ? "default" : "pointer", opacity: loading ? 0.7 : 1 }}>
          {loading ? "Logging in…" : "Log In"}
        </button>
        <div style={{ fontSize: 11.5, color: "var(--fu-text-muted)", textAlign: "center", marginTop: 10, display: "flex", alignItems: "center", justifyContent: "center", gap: 5 }}>
