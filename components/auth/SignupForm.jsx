...
export function SignupForm() {
  ...
  return (
    <div style={{ flex: 1, display: "flex", flexDirection: "column", padding: "50px 26px 30px" }}>
      <Logo height={34} />
      <div style={{ marginTop: 26, fontFamily: "'Space Grotesk',sans-serif", fontWeight: 800, fontSize: 24, color: "#0B0E1A" }}>Create your account</div>
      <div style={{ fontSize: 13.5, color: "#6B7290", marginTop: 6, marginBottom: 20 }}>Built for college athletes.</div>
      ...
      {notice && <div style={{ color: "#1B9A73", fontSize: 12.5, marginBottom: 10, fontWeight: 600 }}>{notice}</div>}
      <button
      ...
      <div style={{ textAlign: "center", fontSize: 13.5, color: "#6B7290", marginTop: 16 }}>
